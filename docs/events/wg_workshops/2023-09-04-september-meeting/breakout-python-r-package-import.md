...
- R has a system command to allow executing aritrary code
...
- File size potentially helps
  - E.g. plausible to extract small amounts of patient data in an encrypted way that passes disclosre control. But unlikely you could do that with 1000s of records

### Paper notes

![image](https://hackmd.io/_uploads/rJGbooVBT.png)
